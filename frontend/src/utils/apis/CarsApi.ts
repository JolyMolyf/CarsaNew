...
export const getCarsByTechnicianId = async (technicianId: string) => {
  return axios
    .get(`${process.env.REACT_APP_API_URL}/cars/techniciancars/${technicianId}`)
    .then((res) => {
...
export const getLastCars = async (clientId: string) => {
  return await axios
    .get(`${process.env.REACT_APP_API_URL}/cars/getclientcars/${clientId}`)
    .then((res) => {
      return res.data;
    })
    .catch((e) => {
...
export const getAllGenerationsForModel = async (model: string) => {
  return await axios
    .get(`${process.env.REACT_APP_API_URL}/cars/generations`, { params: { name: model } })
    .then((res) => {
      return res.data;
    });
};
...
export const getRejectedCars = async () => {
  return await axios
    .get(`${process.env.REACT_APP_API_URL}/cars/rejected`)
    .then((res) => {
      return res.data;
    })
    .catch((e) => e);
...
export const updateCar = async (car: CarType) => {
  return await axios
    .put(`${process.env.REACT_APP_API_URL}/cars/${car.id}`, { ...car })
    .then((res) => {
      return res.data;
    })
    .catch((e) => {
