  ...
  useEffect(() => {
    ...
    if (manualConfiguration?.Model) {
      getAllGenerationsForModel(manualConfiguration.Model || '').then((generations) => {
        setGenerations(
          generations?.map((generation: CarModelType) => {
            return {
              id: uuid(),
      ...
      <div className="carSelector-add-body">
        ...
        <div className="carSelector-add-body-wrapper">
          <div className="carSelector-add-body-manual carSelector-add-body-paper">
            <div className="carSelector-add-body-paper-label">Add Manually</div>
            <div className="carSelector-add-body-manual-body">
              ...
              <TextInput
                className="carSelector-add-body-manual-body-input"
                name="price_from"
                onChange={handleManualConfigurationChange}
                value={manualConfiguration?.price_from}
              ...
              <TextInput
                ...
                name="price_until"
                onChange={handleManualConfigurationChange}
                value={manualConfiguration?.price_until}
              ...
              <TextInput
                ...
                name="year_from"
                onChange={handleManualConfigurationChange}
                value={manualConfiguration?.year_from}
              ...
              <TextInput
                ...
                name="year_until"
                onChange={handleManualConfigurationChange}
                value={manualConfiguration?.year_until}
              ...
              <TextInput
                ...
                name="mileage_from"
                onChange={handleManualConfigurationChange}
                value={manualConfiguration?.mileage_from}
                placeholder="Milage from"
              />
              <TextInput
                className="carSelector-add-body-manual-body-input"
                name="mileage_until"
                onChange={handleManualConfigurationChange}
                value={manualConfiguration?.mileage_until}
                placeholder="Milage until"
              />
              <TextInput
                className="carSelector-add-body-manual-body-input"
                name="engine_volume_from"
                onChange={handleManualConfigurationChange}
                value={manualConfiguration?.engine_volume_from}
                placeholder="Engine Volume from"
              />
              <TextInput
                className="carSelector-add-body-manual-body-input"
                name="engine_volume_until"
                onChange={handleManualConfigurationChange}
                value={manualConfiguration?.engine_volume_until}
                placeholder="Engine Volume until"
              />
              <TextInput
                className="carSelector-add-body-manual-body-input"
                name="power_from"
                onChange={handleManualConfigurationChange}
                value={manualConfiguration?.power_from}
              ...
              <TextInput
                ...
                name="power_until"
                onChange={handleManualConfigurationChange}
                value={manualConfiguration?.power_until}
                placeholder="Power until"
              />
            </div>
          </div>
        </div>
