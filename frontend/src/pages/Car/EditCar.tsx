            ...
            <div>
              ...
              <div>
                <div className="carCard-expanded-specs-wrapper editCar-body-section-wrapper">
                  {createKeyValueArrayFromObject(flattenObject(car || {}), bannedKeys).map(
                      ...
                      if (isInEditMode()) {
                        return (
                          <StyledSpecs key={index}>
                            {key.replaceAll('_', ' ')} :{' '}
                            <input name={key} value={value} onChange={handleSpecEdit}></input>
                          </StyledSpecs>
                        );
                      } else {
                        return (
                          <div key={index} className="carCard-expanded-specs-wrapper-item editCar-inputPair">
                            <div className="carCard-expanded-specs-wrapper-item-key">
                              {item[0].replaceAll('_', ' ')}{' '}
                            </div>{' '}
                            : {item[1]}
                          </div>
