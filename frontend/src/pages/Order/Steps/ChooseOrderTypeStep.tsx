    ...
    return [
      {
        ...
        description: `This service is ideal for you if you have chosen one car that you want to be checked and quite sure that it is in a good condition. Our technician will find all cons of the car and create special report for you.`,
        price: 200,
        action: () => {
      ...
      },
      {
        id: uuid(),
        title: 'Configuration',
        type: PackageType.Configuration,
        description: `This product was created for people who are not keen on the cars or do not have time to search for them.
    Our managers will find the cars for you and technicians will check them giving comprehensive reports for each car.`,
        price: 850,
        action: () => {
  ...
  return (
    <div className="chooseOrderTypeStep">
      {packages.map((item: IPackage) => {
        return (
          <Paper key={item.id}>
            <div className="main-info-text">{item.title}</div>
